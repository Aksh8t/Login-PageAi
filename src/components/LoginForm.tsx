  ...
  return (
    <div className="w-full max-w-md mx-auto slide-in-right">
      ...
      <div className="text-right mb-6">
        <span className="text-muted-foreground font-inter">Don't have an account? </span>
        <button className="text-primary font-medium hover:text-primary-glow transition-colors">
          Sign up
        </button>
      </div>
      ...
      <Card className="p-8 shadow-soft border-0 bg-white/80 backdrop-blur-sm">
        ...
        <div className="space-y-3 mb-6">
          <Button
            ...
            variant="outline"
            className="w-full btn-social py-3"
          >
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <span className="px-4 text-muted-foreground font-inter bg-white">OR</span>
          <div className="border-t border-border flex-1"></div>
        </div>
